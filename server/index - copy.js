...
// Placeholder: /api/download – Phase 2 liefert hier die generierten Dateien aus
app.get('/api/download/:jobId/:filename', (_req, res) => {
  res.status(501).json({
    error: 'Download-Endpunkt noch nicht implementiert (Phase 2).',
  });
});
